...
graph2_data = merged_bison_data |>
  filter(state_code == "MONTANA" | state_code == "WYOMING" | state_code == "NORTH DAKOTA" | state_code == "SOUTH DAKOTA" | state_code == "NEBRASKA" | state_code == "KANSAS" | state_code == "OKLAHOMA" | state_code == "TEXAS" | state_code == "IDAHO" | state_code == "COLORADO" | state_code == "NEW MEXICO")
...
ggplot(graph2_data, aes(x = year, y = `Gross Cost - Hunting Licenses`)) + 
  xlab("Year") +
  ylab("Population") +
  labs(title = "Gross Cost of Hunting Licenses Over Time") +
  geom_point(aes(color = state_code), size = 3) +
  geom_smooth()
